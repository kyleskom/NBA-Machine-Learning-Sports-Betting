...
mcp_save = ModelCheckpoint('C:/Users/antho/cursorProjects/NBA-Machine-Learning-Sports-Betting/Models/Trained-Model-OU-' + current_time, save_best_only=True, monitor='val_loss', mode='min')
