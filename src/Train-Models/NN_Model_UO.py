...
total = data['OU']
data.drop(
    ['index', 'Score', 'Home-Team-Win', 'TEAM_NAME', 'Date', 'index.1', 'TEAM_NAME.1', 'Date.1', 'OU-Cover', 'OU'],
    axis=1,
    inplace=True,
    errors='ignore',
)
...
print(f"Training rows: {x_train.shape[0]} features: {x_train.shape[1]} classes: {class_counts.tolist()}")
